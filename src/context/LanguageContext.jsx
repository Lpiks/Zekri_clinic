...
const translations = {
  fr: {
    ...
    contact_info_desc: "Située à Blida, notre clinique vous accueille dans un cadre confidentiel et moderne pour tous vos besoins en dentisterie d'excellence.",
    contact_label_location: 'Localisation',
    contact_address: 'Blida, Algérie',
  ...
  ar: {
    ...
    contact_info_desc: 'تقع عيادتنا في البليدة، وتستقبلكم في بيئة حديثة وسرية لجميع احتياجاتكم في طب الأسنان المتميز.',
    contact_label_location: 'الموقع',
    contact_address: 'البليدة، الجزائر',
