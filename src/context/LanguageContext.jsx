...
const translations = {
  fr: {
    ...
    nav_admin: 'Admin',
    hero_title: "L'Excellence du Sourire à Alger",
    ...
    contact_info_desc: "Située au cœur de Hydra, notre clinique vous accueille dans un cadre confidentiel et moderne pour tous vos besoins en dentisterie d'excellence.",
    contact_label_location: 'Localisation',
    contact_address: 'Rue Ahmed Ouaked, Hydra, Alger, Algérie',
  ...
  ar: {
    ...
    hero_title: "تميز الابتسامة في الجزائر",
    ...
    contact_info_desc: 'تقع عيادتنا في قلب حيدرة، وتستقبلكم في بيئة حديثة وسرية لجميع احتياجاتكم في طب الأسنان المتميز.',
    contact_label_location: 'الموقع',
    contact_address: 'شارع أحمد واكد، حيدرة، الجزائر العاصمة',
